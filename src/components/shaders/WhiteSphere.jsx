...
function WhiteSphereMesh({ EE }) {
  ...
  useEffect(() => {
    EE.on("tap", () => {
      ...
      if (materialRef.current.uniforms.u_green.value > 0.77)
        materialRef.current.uniforms.u_green.value -= 0.04;
      if (materialRef.current.uniforms.u_blue.value > 0.14)
        materialRef.current.uniforms.u_blue.value -= 0.15;
  ...
  useFrame(({ clock }) => {
    ...
    if (material.uniforms.u_green.value < 1.0)
      material.uniforms.u_green.value += 0.006;
    if (material.uniforms.u_blue.value < 1.0)
      material.uniforms.u_blue.value += 0.022;
