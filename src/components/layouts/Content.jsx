...
export default function Content() {
  ...
  return (
    <div className="sm:flex sm:flex-row flex flex-col gap-8 mt-4 items-stretch min-h-[680px] md:h-[400px] md:min-h-[400px]">
      <div className="w-[100%] sm:w-[50%] w-full h-full h-[450px] min-h-[400px] md:h-[400px]">
